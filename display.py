...
#             label = tk.Label(window, text=str(labelsY[x][len(labelsY[x])-1-y]), width = 1, height = 1, borderwidth=0, relief="flat") #width=3*size, height=2*size)
...
#             label = tk.Label(window, text=str(labelsX[y][len(labelsX[y])-1-x]), width = 1, height = 1, borderwidth=0, relief="flat") #width=3*size, height=2*size)
